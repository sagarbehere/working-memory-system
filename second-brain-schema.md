...
- **Don't tag one-offs.** A tag is only worth creating the second time you need it. First mention of a new topic goes untagged or under the closest existing tag; promote it to its own tag only if it recurs.
